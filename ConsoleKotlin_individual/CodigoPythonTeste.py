    ...
    if g.latlng:
        ...
        if mydb_sql_server:
            ...
            with mydb_sql_server.cursor() as mycursor_sql_server:
                sql_query_sql_server = f"INSERT INTO geolocalizacao (endereco, latitude, longitude, fkDispositivo) VALUES ('{local}', {latitude}, {longitude}, {7})"
                valores_sql_server = (local, latitude, longitude, data_atual, hora_atual, 7)
